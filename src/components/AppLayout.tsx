        ...
        <div className="right-drawer-content">
          ...
          <div style={{ padding: '0.5rem 1rem 0.5rem 1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.5rem' }}>
              ...
              <Link to="/projects-database" onClick={() => setIsRightDrawerOpen(false)} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textDecoration: 'none', gap: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.7rem', color: '#333', textAlign: 'center', fontWeight: '500' }}>Company Experience</span>
              </Link>
          ...
          <div style={{ padding: '0.5rem 1rem 0.5rem 1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.5rem' }}>
              ...
              <a href="/projects-database/3d" target="_blank" rel="noopener noreferrer" onClick={() => setIsRightDrawerOpen(false)} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textDecoration: 'none', gap: '0.5rem' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'linear-gradient(145deg, #ffffff, #e6e6e6)', boxShadow: '4px 4px 8px rgba(0, 0, 0, 0.08), -4px -4px 8px rgba(255, 255, 255, 0.9)', display: 'flex', justifyContent: 'center', alignItems: 'center', transition: 'all 0.2s', border: '1px solid rgba(255,255,255,0.4)' }}>
                  <Database size={20} color="#cc0000" strokeWidth={2} style={{ filter: 'drop-shadow(1px 2px 2px rgba(204, 0, 0, 0.3))' }} />
                </div>
                <span style={{ fontSize: '0.7rem', color: '#333', textAlign: 'center', fontWeight: '500' }}>Projects Database</span>
              </a>
            </div>
          </div>
