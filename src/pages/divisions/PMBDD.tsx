...
export default function PMBDD() {
  const modules = [
    { name: 'Project Pipeline', icon: <Briefcase size={24} />, desc: 'Track upcoming projects and leads' },
    { name: 'Business Strategy', icon: <Target size={24} />, desc: 'Define and monitor division goals' },
    { name: 'Bid Management', icon: <FileText size={24} />, desc: 'Manage proposals and tender submissions' },
    { name: 'Client Relations', icon: <Users size={24} />, desc: 'CRM and client feedback tracking' },
    { name: 'Performance Metrics', icon: <BarChart size={24} />, desc: 'Analytics and divisional KPIs' },
  ];
