...
export default function PEDTransportationStudies() {
  return (
    <div className="responsive-container" style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
      <div style={{ marginBottom: '2rem', padding: '0 1rem' }}>
        <h1 style={{ color: 'var(--primary-color)', fontSize: '2rem', fontWeight: 600 }}>Transportation Studies</h1>
        ...
        <div style={{ flex: '1 1 30%', minWidth: '300px' }}>
          ...
          >
            <AppButton 
              ...
              description="Analyze traffic flow, intersection capacity, and mobility metrics." 
              icon={<Car size={24} />} 
              onClick={() => window.open('#', '_blank')} 
              colorStart="#8b5cf6" colorEnd="#5b21b6" shadowColor="#4c1d95"
            />
          </motion.div>
        </div>
      </div>
