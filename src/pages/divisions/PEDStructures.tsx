...
export default function PEDStructures() {
  const navigate = useNavigate();

  return (
    <div className="responsive-container" style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
      <div style={{ marginBottom: '2rem', padding: '0 1rem' }}>
        <h1 style={{ color: 'var(--primary-color)', fontSize: '2rem', fontWeight: 600 }}>Structural Design</h1>
      ...
      <div style={{ display: 'flex', gap: '2rem', padding: '0 1rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: '1 1 30%', minWidth: '300px' }}>
          ...
          >
            <AppButton 
              title="AASHTO Bridge Designer" 
              description="Design and analyze bridges according to AASHTO specifications." 
              icon={<Building size={24} />} 
              onClick={() => navigate('/division/ped/aashto-bridge-designer')} 
